...
class CertificateBundle {
   ...
   * @property {string} [policy.issuerParameters.validationMethod] The method
   * the issuer will use to validate certificate creation and renewal requests.
   * Possible values include: 'email', 'dns-txt-token', 'http-token'
   * @property {array} [policy.issuerParameters.validationEmails] A list of
   * email addresses where validation emails should be sent for specific DNS
   * names.
